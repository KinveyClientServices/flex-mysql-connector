...
function transformEntity(entity, modules) {
  ...
  if (entity.employeeId == null) {
    return new Error('No ID field (employeeId) present in the resulting entity');
  }
...
function transformForWrite(entity) {
  return {
    FirstName: entity.firstName,
    LastName: entity.lastName,
    Email: entity.email,
    HomePhone: entity.phone != null ? entity.phone.home : null,
    MobilePhone: entity.phone != null ? entity.phone.mobile : null
  }
}
